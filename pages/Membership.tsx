...
const INITIAL_POSTS = [
  { id: 1, user: "Carla M.", tier: "gold", text: "¡Chicas! Apliqué la técnica de limado que sugirió Juan en la sección Silver y mis tiempos bajaron 15 minutos. ¡Recomendadísimo!", likes: 12, time: "Hace 2 horas" },
  { id: 2, user: "Andrea R.", tier: "bronze", text: "¿Alguien sabe qué lámpara recomiendan para el Gel Red Velvet? Me encanta el color.", likes: 4, time: "Hace 5 horas" },
  { id: 3, user: "Sofia T.", tier: "silver", text: "Acabo de descargar la calculadora de costos. Me di cuenta que estaba cobrando muy poco por el Nail Art a mano alzada.", likes: 8, time: "Hace 1 día" }
];
...
const GlobalCommunity = ({ userTier, userName }: { userTier: string, userName: string }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto mb-16">
          ...
          <div className="flex gap-4">
             ...
             <form onSubmit={handlePost} className="flex-1">
                <textarea 
                  ...
                  placeholder="Comparte un tip, haz una pregunta o saluda a la comunidad..."
                  className="w-full border-gray-200 rounded-lg p-3 text-sm focus:ring-black focus:border-black resize-none bg-gray-50"
                  rows={2}
                ></textarea>
                <div className="flex justify-between items-center mt-2">
                   <span className="text-xs text-gray-400">Tu post será visible para todos los niveles.</span>
                   <button type="submit" className="bg-black text-white px-6 py-2 rounded text-xs font-bold uppercase hover:bg-zinc-800 flex items-center gap-2">
       ...
       <div className="space-y-4">
          {posts.map(post => (
             <div key={post.id} className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 hover:border-gray-300 transition">
                   ...
                   <div className="flex items-center gap-3">
                      ...
                      <div>
                         <h5 className="font-bold text-sm flex items-center gap-2">
                            {post.user}
                            <span className={`text-[10px] uppercase border px-1.5 py-0.5 rounded ${getTierColor(post.tier)}`}>
                               {post.tier}
                            </span>
                         </h5>
                ...
                <p className="text-gray-700 text-sm mb-4 leading-relaxed">{post.text}</p>
                <div className="flex items-center gap-6 border-t border-gray-50 pt-3">
                   <button className="flex items-center gap-2 text-xs text-gray-500 hover:text-black transition">
                      <ThumbsUp size={14} /> {post.likes} Me gusta
                   </button>
                   <button className="flex items-center gap-2 text-xs text-gray-500 hover:text-black transition">
...
export const Membership = () => {
  ...
  const handleCancel = (e: React.FormEvent) => {
    e.preventDefault();
    alert('Gracias por tu retroalimentación. Tu suscripción ha sido cancelada.');
      ...
      return (
          <div className="container mx-auto px-4 py-12 max-w-lg">
              ...
              <div className="bg-white p-8 shadow-xl rounded-lg border border-gray-200">
                  ...
                  <p className="text-3xl font-bold mb-6">{selectedTier === 'silver' ? '$10.00' : '$25.00'} <span className="text-sm font-normal text-gray-500">/ mes</span></p>
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                ...
                <ul className="space-y-2 mb-6 text-sm text-gray-600">
                    ...
                    <li>• 5% Descuento en productos</li>
                ...
                <p className="text-3xl font-bold mb-4">$10 <span className="text-sm font-normal">/mes</span></p>
                <ul className="space-y-2 mb-6 text-sm text-gray-600">
                ...
                <p className="text-3xl font-bold mb-4">$25 <span className="text-sm font-normal">/mes</span></p>
                <ul className="space-y-2 mb-6 text-sm text-gray-600">
                    <li>• Todo lo de Plata</li>
                    <li>• 20% Descuento en productos</li>
                    <li>• Mentoría 1 a 1</li>
