...
import { Trash2, CreditCard, Check, ShieldCheck } from 'lucide-react';
...
export const Checkout = () => {
  const { cart, removeFromCart, cartTotal, discount, applyCoupon, clearCart, shippingDetails, setShippingDetails } = useStore();
  ...
  const handleApplyCoupon = () => {
    ...
    if (success) alert('Cupón aplicado con éxito');
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <h1 className="text-3xl font-bold uppercase text-center mb-8 tracking-widest">Finalizar Compra</h1>
      <Steps current={step} />
            ...
            <div className="bg-white p-6 shadow-lg border border-gray-100">
               ...
               <form className="grid grid-cols-1 gap-4">
                 ...
                 <button 
                  type="button"
                  onClick={() => {
                    if(!shippingDetails.address) return alert('Por favor llena la dirección');
                    setStep(2);
                  }}
