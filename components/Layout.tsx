  ...
  return (
    <div className="min-h-screen flex flex-col relative bg-white">
      ...
      <header className="bg-black text-white sticky top-0 z-50 transition-all duration-300">
        ...
        <nav className="hidden lg:flex w-full justify-center pb-8 pt-4">
           {/* Increased gap from 12 to 16/20 for "Longer" menu feel */}
           <div className="flex gap-16 xl:gap-20 text-[11px] uppercase tracking-[0.2em] font-medium text-gray-300 items-center">
              <Link to="/" className="hover:text-white hover:underline underline-offset-8 decoration-1 transition-all">Inicio</Link>
              <Link to="/shop" className="hover:text-white hover:underline underline-offset-8 decoration-1 transition-all">Shop</Link>
              <Link to="/academy/online" className="hover:text-white hover:underline underline-offset-8 decoration-1 transition-all">Academia Online</Link>
              <Link to="/academy/presencial" className="hover:text-white hover:underline underline-offset-8 decoration-1 transition-all">Academia Presencial</Link>
              <Link to="/distributors" className="hover:text-white hover:underline underline-offset-8 decoration-1 transition-all">Distribuidores</Link>
              
              {/* Suscripciones: Changed from yellow to a subtle Champagne/Pale Gold color */}
              <Link to="/membership" className="text-orange-50 font-bold hover:text-white hover:underline underline-offset-8 decoration-1 transition-all">Suscripciones</Link>
              
              <Link to="/club" className="hover:text-white hover:underline underline-offset-8 decoration-1 transition-all">Club</Link>
              <Link to="/rent" className="hover:text-white hover:underline underline-offset-8 decoration-1 transition-all">Espacios</Link>
              <Link to="/about" className="hover:text-white hover:underline underline-offset-8 decoration-1 transition-all">Conócenos</Link>
           </div>
        </nav>
        ...
        {isMenuOpen && (
          <div className="lg:hidden bg-zinc-900 absolute w-full top-full left-0 flex flex-col shadow-xl border-t border-gray-800 z-50 h-[calc(100vh-80px)] overflow-y-auto">
            <div className="p-8 flex flex-col space-y-6 text-sm uppercase tracking-[0.2em]">
                <Link to="/" onClick={() => setIsMenuOpen(false)} className="py-2 border-b border-gray-800">Inicio</Link>
                <Link to="/shop" onClick={() => setIsMenuOpen(false)} className="py-2 border-b border-gray-800">Shop</Link>
                <Link to="/academy/online" onClick={() => setIsMenuOpen(false)} className="py-2 border-b border-gray-800">Academia Online</Link>
                <Link to="/academy/presencial" onClick={() => setIsMenuOpen(false)} className="py-2 border-b border-gray-800">Academia Presencial</Link>
                <Link to="/membership" onClick={() => setIsMenuOpen(false)} className="py-2 border-b border-gray-800 text-orange-100 font-bold">Suscripciones</Link>
                <Link to="/club" onClick={() => setIsMenuOpen(false)} className="py-2 border-b border-gray-800">Club</Link>
                <Link to="/rent" onClick={() => setIsMenuOpen(false)} className="py-2 border-b border-gray-800">Espacios</Link>
                <Link to="/distributors" onClick={() => setIsMenuOpen(false)} className="py-2 border-b border-gray-800">Distribuidores</Link>
                <Link to="/about" onClick={() => setIsMenuOpen(false)} className="py-2 border-b border-gray-800">Conócenos</Link>
                {!user ? (
                   <Link to="/login" onClick={() => setIsMenuOpen(false)} className="py-4 font-bold text-white mt-4">Iniciar Sesión</Link>
                ) : (
